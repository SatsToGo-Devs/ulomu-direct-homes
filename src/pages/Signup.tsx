...
const Signup = () => {
  ...
  const handleMicrosoftSignUp = async () => {
    ...
    if (error) {
      toast({
        title: "Error signing up with Microsoft",
        description: error.message,
        variant: "destructive",
      });
    }
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <Button 
                        ...
                        variant="outline" 
                        className="w-full border-beige hover:bg-gray-50"
                      >
                      ...
                      >
                        <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                          <path fill="#F25022" d="M12 12H0V0h12v12z"/>
                          <path fill="#00A4EF" d="M24 12H12V0h12v12z"/>
                          <path fill="#7FBA00" d="M12 24H0V12h12v12z"/>
                          <path fill="#FFB900" d="M24 24H12V12h12v12z"/>
                        </svg>
